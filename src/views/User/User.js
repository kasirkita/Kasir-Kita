...
export class User extends Component {
    ...
    render() {
        ...
        const theads = [
            ...
            { name: 'role.name', value: 'Peranan', sortable: true },
                        ...
                        <Table theads={theads} ordering={ordering} handleSorting={this.handleSorting}>
                            <tr>
                                <td className="text-center">
                                    <img src="https://s.gravatar.com/avatar/dbe830afd9174dff8a1bedb0ffcea478?s=80" alt="John Doe" className="img-fluid rounded-circle" width="50" />
                                </td>
                            ...
                            <tr>
                                <td className="text-center">
                                    <img src="https://s.gravatar.com/avatar/19f1cf9979bfaaab132e5d4c103faa82?s=80" alt="John Doe" className="img-fluid rounded-circle" width="50" />
                                </td>
