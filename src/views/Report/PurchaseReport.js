...
export class PurchasReport extends Component {
    state = {
        start_date: new Date(),
        end_date: new Date(),
        ordering: {
               ...
               <div className="row p-3"> 
                    ...
                    <div className="col-md-12 mt-3">
                        ...
                        <table className="table table-bordered">
                            <tfoot>
                                <tr>
                                    <td colSpan="4" className="text-right">Total Pembelian Barang</td>
                                    <td className="text-right">2</td>
                                </tr>
                                <tr>
                                    <td colSpan="4" className="text-right">Total Pembelian</td>
                                    <td className="text-right">Rp.3,600</td>
                                </tr>
                            </tfoot>
                        </table>
                        <hr/>
