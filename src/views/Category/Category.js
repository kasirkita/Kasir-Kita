...
export class Category extends Component {
    ...
    render() {
        const { ordering, deleteModal, createModal } = this.state;
        ...
        return (
            <Fragment>
                <div className="row p-3"> 
                    ...
                    <Modal visible={createModal} dialogClassName="modal-sm" onClickBackdrop={this.handleCloseCreateModal}>
                        ...
                        <div className="modal-footer">
                            ...
                            <button type="button" className="btn btn-primary"><i className="mdi mdi-content-save mr-2"></i>Simpan</button>
                        </div>
                    </Modal>
                        ...
                        <Table theads={theads} ordering={ordering} handleSorting={this.handleSorting}>
                            <tr>
                                ...
                                <td>
                                    ...
                                    <button className="btn p-0 text-success btn-link btn-small">Ubah</button>
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <td>Minuman Serbuk</td>
                                <td className="text-center"><input type="checkbox" defaultChecked={true} /></td>
                                <td>
                                    <button className="btn p-0 text-danger text-sm btn-link btn-small mr-3">Hapus</button>
                                    <button className="btn p-0 text-success text-sm btn-link btn-small">Ubah</button>
                                </td>
                            </tr>
                            <tr>
                                <td>Minuman</td>
